        ...
        <div className="mt-12 lg:mt-16">
          <div className="border-b">
            <nav className="flex gap-8">
              ...
              <button className="pb-4 border-b-2 border-transparent text-muted hover:text-foreground">
                Specifications
              </button>
              <button className="pb-4 border-b-2 border-transparent text-muted hover:text-foreground">
                Storage
          ...
          <div className="py-8">
            <div className="prose max-w-none">
              ...
              {product.researchApplications.length > 0 && (
                <>
                  <h4 className="text-lg font-semibold mb-3">Research Applications</h4>
              ...
              {product.sequence && (
                <>
                  <h4 className="text-lg font-semibold mb-3">Amino Acid Sequence</h4>
                  <p className="font-mono text-sm bg-background-secondary p-4 rounded-lg break-all">
                    {product.sequence}
                  </p>
                </>
              )}

              <h4 className="text-lg font-semibold mb-3 mt-6">Storage Instructions</h4>
