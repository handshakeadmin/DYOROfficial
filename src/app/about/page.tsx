...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about PeptideSource - your trusted source for premium research-grade peptides with 99%+ purity.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              About <span className="text-accent">PeptideSource</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted mb-4">
                At PeptideSource, pride in our craftsmanship is at the heart of everything
