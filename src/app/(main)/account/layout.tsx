      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 flex-shrink-0">
            <div className="bg-card rounded-md border border-border p-6 sticky top-24">
              {/* User Info */}
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <button
                  onClick={() => signOut()}
                  className="flex items-center gap-3 px-4 py-2.5 rounded text-sm font-medium text-error hover:bg-error/10 transition-colors w-full"
                >
