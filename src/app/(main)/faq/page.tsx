...
export const metadata: Metadata = {
  title: "FAQ",
  description: "Frequently asked questions about DYORWellness products, shipping, and research peptides.",
};
    ...
    questions: [
      {
        ...
        answer: "All DYORWellness peptides exceed 99% purity. Each batch undergoes rigorous testing via HPLC (High-Performance Liquid Chromatography) and mass spectrometry to verify purity and molecular identity. Certificates of Analysis are available upon request.",
      },
      {
        question: "What forms are your peptides available in?",
        answer: "All of our peptides are available as lyophilized (freeze-dried) powder in sealed vials. This format offers excellent stability and shelf life. The peptides require reconstitution with appropriate solvents (such as bacteriostatic water) before use in research applications.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Orders can be modified or cancelled before they are shipped. Once an order has been dispatched, it cannot be cancelled. Please contact us immediately at info@dyorwellness.com if you need to make changes.",
      },
      {
        question: "Do you offer bulk or wholesale pricing?",
        answer: "Yes, we offer competitive pricing for bulk orders. Please contact our sales team at info@dyorwellness.com with your requirements for a custom quote.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Yes! We offer FREE shipping on ALL orders within the USA. No minimum purchase required. International shipping rates vary by destination.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Please email info@dyorwellness.com with your order number, a description of the issue, and any relevant photos. Our team will respond within 24 business hours.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "No. All products sold by DYORWellness are strictly for research, laboratory, and analytical purposes only. They are not intended for human or veterinary use. By purchasing, you confirm you are a qualified researcher using these products for legitimate research purposes only.",
      },
      {
